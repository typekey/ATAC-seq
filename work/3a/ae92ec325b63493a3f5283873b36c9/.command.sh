...
featureCounts \
    ...
    OSMOTIC_STRESS_T100_SE_REP2.sorted.bam OSMOTIC_STRESS_T100_SE_REP1.sorted.bam OSMOTIC_STRESS_T0_PE_REP2.sorted.bam OSMOTIC_STRESS_T0_PE_REP1.sorted.bam
