...
computeMatrix \
    ...
    --outFileName OSMOTIC_STRESS_T100_SE_REP2.scale_regions.computeMatrix.mat.gz \
    --outFileNameMatrix OSMOTIC_STRESS_T100_SE_REP2.scale_regions.computeMatrix.vals.mat.tab \
