...
computeMatrix \
    ...
    --scoreFileName OSMOTIC_STRESS_T100_SE_REP2.bigWig \
    --outFileName OSMOTIC_STRESS_T100_SE_REP2.reference_point.computeMatrix.mat.gz \
    --outFileNameMatrix OSMOTIC_STRESS_T100_SE_REP2.reference_point.computeMatrix.vals.mat.tab \
