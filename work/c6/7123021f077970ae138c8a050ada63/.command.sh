...
computeMatrix \
    ...
    --scoreFileName OSMOTIC_STRESS_T100_SE_REP1.bigWig \
    --outFileName OSMOTIC_STRESS_T100_SE_REP1.reference_point.computeMatrix.mat.gz \
    --outFileNameMatrix OSMOTIC_STRESS_T100_SE_REP1.reference_point.computeMatrix.vals.mat.tab \
