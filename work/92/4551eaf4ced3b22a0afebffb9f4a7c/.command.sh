...
computeMatrix \
    ...
    --scoreFileName OSMOTIC_STRESS_T0_PE_REP2.bigWig \
    --outFileName OSMOTIC_STRESS_T0_PE_REP2.reference_point.computeMatrix.mat.gz \
    --outFileNameMatrix OSMOTIC_STRESS_T0_PE_REP2.reference_point.computeMatrix.vals.mat.tab \
