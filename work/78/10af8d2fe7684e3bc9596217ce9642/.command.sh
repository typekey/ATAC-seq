...
computeMatrix \
    ...
    --outFileName OSMOTIC_STRESS_T15_PE_REP1.reference_point.computeMatrix.mat.gz \
    --outFileNameMatrix OSMOTIC_STRESS_T15_PE_REP1.reference_point.computeMatrix.vals.mat.tab \
